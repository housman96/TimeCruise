...
public class GeneriquePierreArrested : MonoBehaviour
{
    ...
    public IEnumerator generique()
    {
        ...
        /*CAPITAINE*/
        text.text = "Le capitaine a survécu à ses blessures.";
        ...
        text.text = "Jean continua d'essayer de se rapprocher de sa famille, et entretient une correspondance assidue avec Julie et le Capitaine.";
